...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> SKIN_TAG = ITEMS.register("skin_tag", () -> new SkinTag((new Item.Properties()).tab(ModCreativeModeTab.CREATIVE_MODE_TAB)));
    ...
    public static final RegistryObject<Item> SCHEDULE_WORK = ITEMS.register("schedule_work", () -> new ScheduledEvent(ScheduledEvent.EventType.WORK, (new Item.Properties()).tab(ModCreativeModeTab.CREATIVE_MODE_TAB)));
    public static final RegistryObject<Item> SCHEDULE_REST = ITEMS.register("schedule_rest", () -> new ScheduledEvent(ScheduledEvent.EventType.REST, (new Item.Properties()).tab(ModCreativeModeTab.CREATIVE_MODE_TAB)));
    public static final RegistryObject<Item> SCHEDULE_MEET = ITEMS.register("schedule_meet", () -> new ScheduledEvent(ScheduledEvent.EventType.MEET, (new Item.Properties()).tab(ModCreativeModeTab.CREATIVE_MODE_TAB)));
